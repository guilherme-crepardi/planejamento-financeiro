...
export default function Dashboard() {
  ...
  return (
    <div className="max-w-[1280px] mx-auto px-2 md:px-0 space-y-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 animate-fade-in-up" style={{ animationDelay: "50ms" }}>
        {summaryCards.map((card) => (
          <div key={card.label} className="card p-10 group hover:scale-[1.02] transition-all duration-300">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 animate-fade-in-up" style={{ animationDelay: "100ms" }}>
                ...
                {gastos.slice(-10).reverse().map((g) => {
                  ...
                  return (
                    <tr key={g.id} className="table-row" style={{ borderBottom: "1px solid var(--border-subtle)" }}>
                      <td className="py-6 px-6 font-bold text-[var(--text-primary)]">{g.descricao}</td>
                      ...
                      <td className="py-6 px-6 text-right font-extrabold text-[15px]" style={{ color: "var(--danger)" }}>{fmt(g.valor)}</td>
                    </tr>
                  );
                })}
              </tbody>
